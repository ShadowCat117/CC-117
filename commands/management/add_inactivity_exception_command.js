...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .setDescription(
            'Adds a custom inactivity threshold for a player. Default length is forever.',
        )
        .addStringOption((option) =>
            option
                .setName('username')
                .setDescription(
                    'The name of the player you want to be have a custom inactivity threshold.',
                )
                .setRequired(true),
        )
        .addIntegerOption((option) =>
            option
                .setName('duration')
                .setDescription(
                    'What should their custom inactivity threshold be?',
                ),
        ),
    ephemeral: true,
    async execute(interaction) {
        ...
        try {
            ...
            if (response.playerUuids !== undefined) {
                ...
                // Error whilst trying to add inactivity exception
                errorEmbed
                    .setTitle('Error')
                    .setDescription(
