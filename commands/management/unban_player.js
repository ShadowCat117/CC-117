...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option =>
            option.setName('username')
                .setDescription('The name of the player to remove from the ban list')
                .setRequired(true)),
    ephemeral: true,
    async execute(interaction) {
        ...
        try {
            ...
            // Call unbanPlayer
            const response = await unbanPlayer(interaction, false);
            ...
            console.log(error);
            await interaction.editReply('Error unbanning player');
            return;
        }
    },
};
