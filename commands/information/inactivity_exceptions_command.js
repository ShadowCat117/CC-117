    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (Object.keys(config['inactivityExceptions']).length > 25) {
                ...
                const pages = [];
                for (let i = 0; i < Object.keys(config['inactivityExceptions']).length; i += 25) {
                    pages.push(Object.keys(config['inactivityExceptions']).slice(i, i + 25));
                }
                ...
                for (const page of pages) {
                    ...
                    pageEmbed
                        ...
                        .setDescription('These players have custom inactivity thresholds.')
                        .setColor(0x00ffff);
