const { ActionRowBuilder, ButtonBuilder, ButtonStyle, StringSelectMenuBuilder, StringSelectMenuOptionBuilder, Events } = require('discord.js');
            ...
            switch (message.messageType) {
                case MessageType.ACTIVE_HOURS:
                    ...
                    if (result.pages[0] === 'No data') {
                        interaction.update({ content: `No activity data found for ${interaction.customId}`, components: [] });
                    } else {
                        ...
                        interaction.update({ content: result.pages[0], components: [row] });
                    }
                ...
                case MessageType.ADD_ALLY:
                    ...
                    interaction.update({ content: result.pages[0], components: [] });
                ...
                case MessageType.LAST_LOGINS:
                    ...
                    if (result.pageCount > 1) {
                        ...
                        if (result.pages[0] === '```\n```') {
                            interaction.update({ content: `No players found in the guild ${interaction.customId}`, components: [] });
                        } else {
                            interaction.update({ content: result.pages[0], components: [] });
                        }
                    }
                ...
                case MessageType.VERIFY:
                    ...
                    switch (result) {
                        case 1:
                            interaction.update({ content: 'Successfully verified', components: [] });
                            break;
                        case 2:
                            interaction.update({ content: 'Successfully verified as ally', components: [] });
                            break;
                        default:
                            interaction.update({ content: 'Failed to verify', components: [] });
                            break;
                    }
